...
const Cabinet = ({ position, color = "#6688aa", onDoubleClick, cabinetId, cabinetData }) => {
  ...
  // 直接获取纹理URL
  const textureUrl = cabinetData?.image && cabinetData.image !== 'default' 
    ? cabinetData.image 
    : defaultCabinetImage;
        ...
        <div style={{
          ...
          {selectedCabinet.cabinetData && (
            <>
              ...
              {selectedCabinet.cabinetData.image && selectedCabinet.cabinetData.image !== 'default' && (
                <div style={{ marginBottom: 20 }}>
                  <strong>图片:</strong> 
                  <div style={{ marginTop: 8, width: 100, height: 100 }}>
                    <img 
                      src={selectedCabinet.cabinetData.image} 
